...
|[PlotQA: Reasoning over Scientific Plots](https://scholar.google.com/scholar?q=PlotQA%3A+Reasoning+over+Scientific+Plots)|Proc. IEEE/CVF Winter Conf. Appl. Comput. Vis. (WACV)|2020|
|[ChartQA: A Benchmark for Question Answering about Charts with Visual and Logical Reasoning](https://scholar.google.com/scholar?q=ChartQA%3A+A+Benchmark+for+Question+Answering+about+Charts+with+Visual+and+Logical+Reasoning)|Findings of ACL|2022|
...
|[OneChart: Purify the Chart Structural Extraction via One Auxiliary Token](https://scholar.google.com/scholar?q=OneChart%3A+Purify+the+Chart+Structural+Extraction+via+One+Auxiliary+Token)|Proc. ACM Int. Conf. Multimedia (ACM MM)|2024|
