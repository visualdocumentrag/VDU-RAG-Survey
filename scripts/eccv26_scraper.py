...
Usage (Colab):
  ...
  !python eccv26_scraper.py              # full (with abstracts)
  !python eccv26_scraper.py --no-abstract   # 1 minute, titles only
"""
...
DATA = SITE + "/static/virtual/data/eccv-2026-orals-posters.json"
...
def load_rows():
    ...
    raw = r.json()
    json.dump(raw, open("eccv26_raw.json", "w"))
...
def main():
    ...
    print("Downloading ECCV 2026 data file ...")
    ...
    with pd.ExcelWriter("ECCV26_papers.xlsx", engine="openpyxl") as xw:
