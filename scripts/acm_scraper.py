#!/usr/bin/env python3
"""
ACM conference COMPLETE paper scraper via Crossref (CIKM, KDD, WWW, SIGIR, MM ...)
-----------------------------------------------------------------------------------
...
def main():
    ...
    ap.add_argument("--acronym", default="CIKM '25")
    ap.add_argument("--query", default="International Conference on Information and Knowledge Management")
    ap.add_argument("--from-date", default="2025-06-01")
    ap.add_argument("--seed", nargs="*", default=[], help="known proceedings DOI(s), always included")
    args = ap.parse_args()
    ACR = args.acronym
    global FROM_DATE
