#!/usr/bin/env python3
"""
JOURNAL COMPLETE paper scraper via Crossref (TPAMI, PR, IJCV, TIP, IJDAR, CVIU; any year)
-----------------------------------------------------------------------------------
...
Usage (Colab):
  ...
  !python journal_scraper.py --journal PR --year 2026
...
def main():
    ...
    ap.add_argument("--journal", default="TPAMI", choices=sorted(JOURNALS))
